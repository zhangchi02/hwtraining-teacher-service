...
import com.huawei.hwtraining.student.service.api.SurveyManager;
...
* @date 2018年1月30日    
*/
public interface StudentServiceDbAdapter extends DbAdapter,StudentScoreManager,ForumManager,SurveyManager{
}
